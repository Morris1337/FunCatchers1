        ...
        <section class="section-wrapper very-top-padding">
          <div class="background-inner1"><!-- add parallax background -->
              ...
              <img src="images/shadow-top.png" class="shadow-top" alt="shadow">  
                ...
                <div class="container">
                <h2 class="section-title"><?php echo $lang['chat']?><br /><span><?php echo $lang['userschat']?></span></h2>
              ...
              <div class="container sixteen-columns" >
                ...
                <table border='1' style='border-collapse: collapse;'>
                  <tr>
                    ...
                    <th class="text-center"><?php echo $lang['message']?></th>
                    <th class="text-center"><?php echo $lang['date']?></th>
                </tr>
                <tr>
                    <th class="text-center"><?php echo $_SESSION['username']?></th>
                    <th>
                      <textarea style="text-align:center;" type="text" rows="5" cols="5" name="areatext" placeholder="<?php echo $lang['typetext']?>" id="areatext" value="" onkeyup="checkVal()"></textarea>
                    </th>
                    <th class="text-center"><button id='myBtn' class='userinfo' disabled><?php echo $lang['send']?></button></th>
                </tr>
                
            </table>
            <input style="display: none" type="text" id="message" name="message" value="">
...
while( $row = mysqli_fetch_array($result, MYSQLI_ASSOC) ){ ?>
            ...
            $(document).ready(function(){
                ...
                $('.userinfo').click(function(){
                    ...
                    var message = $("textarea[id='areatext']").val();
...
<script>
  function checkVal() {
  var count = document.getElementById("areatext").value;
