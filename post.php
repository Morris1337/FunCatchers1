...
$current_file_name_id = substr($current_file_name_id, 4);
$current_file_name_id = chop($current_file_name_id,".php");

                $sql = "select * from events WHERE id = $current_file_name_id";
...
<?php if ($rowKeysValues[$i] == "filename") {
              // Get images from the database
                    $imageURL = "images/post/".$rowValues[$i]; $i++;?>
          <tr>
            <th>
        ...
        <tr>
          <td>
            <?php if ($rowKeysValues[$i] == "location") {
              ?><a href="<?php echo $rowValues[$i+1]?>" target="blank"><?php echo $rowValues[$i]?></a><?php
              $i++;
            } else {
             echo($rowValues[$i])."<br>"; } ?>         
          </td>
