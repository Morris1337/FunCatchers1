        ...
        <section class="section-wrapper very-top-padding">
          <div class="background-inner1"><!-- add parallax background -->
              ...
              <img src="images/shadow-top.png" class="shadow-top" alt="shadow">  
                ...
                <div class="container">
                <h2 class="section-title"><?php echo $lang['challenge']?><br /><span><?php echo $lang['challengeselect']?></span><br /></h2>
                
                    
       <table>
        <tr>
          <th style="background-color: #32CD32">
            <?php echo $lang['actual']?>
          </th>
...
$sql = "SELECT * FROM `challenges` WHERE ? BETWEEN eventdate AND eventdate2";
...
<h6 class="blink" style="float:left; color: black">
...
<br>
  ...
  $imageURL = "images/challenge/".$row['filename']?>
      ...
      <tr>
          <td>
            <a href="<?php echo 'challenge'.$row['id'].'.php'?>"><?php echo $lang['readmore']?></a> 
          </td>
      </tr>
      <tr style="background-color: #32CD32">
          <td>
            <a href="<?php echo 'challenge'.$row['id'].'.php'?>"><img src="<?php echo $imageURL?>"></a>
          </td>
      </tr>
...
$db = connectDatabase();
$todaydate = date("Y-m-d");
$sql = "SELECT * FROM `challenges` WHERE ? > eventdate AND ? > eventdate2 ORDER BY eventdate DESC";
