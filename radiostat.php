<?php
                            ...
                            //LIVE STREAM
                            $data = json_decode(file_get_contents("http://a1.radioheart.ru:8011/json.xsl?mount=/RH63012"));
                            if (!count($data->mounts) || strlen($data->mounts[0]->server_name) < 2) {
                                //NONSTOP
                                $data = json_decode(file_get_contents("http://a1.radioheart.ru:8011/json.xsl?mount=/nonstop"));
                            }
