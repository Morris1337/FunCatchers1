...
function sendRequest() {
	...
	jQuery('#contactWrapper').append('<div class="success"><h4>Vēstule veiksmīgi nosūtīta!</h4><br><p>Paldies ka izmantojāt mūsu kontakta formu <strong>'+name+'</strong>!</p></div>');
	}
}
function sendRequest_news() {
	...
	jQuery('.intro-form-wrap').append('<div class="success"><h4>Parakstīšanās ir veiksmīgi nosūtīta!</h4><br><p>Paldies, ka pierakstījāties uz jaunumiem <strong>'+name+'</strong>! Jūsu ē-pasta adrese ir reģistrēta.</p></div>');
	}
}
...
function check_values() {
	...
	var errors=0;
	 ...
	 if($j('#contactform #name').val()=='') {
	 	...
	 	if(!hasClass)
	 	    $j('#contactform #name').parent().append('<label for="contactname" generated="true" class="error">Lūdzu, ievadiet savu vārdu</label>');
		...
		var hasClass=$j('#contactform #email').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform #email').parent().append('<label for="contactname" generated="true" class="error">Lūdzu ievadiet derīgu e-pasta adresi</label>');	
		...
		var hasClass=$j('#contactform #phone').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform #phone').parent().append('<label for="contactname" generated="true" class="error">Lūdzu ievadiet derīgu telefona numuru</label>');	
		...
		var hasClass=$j('#contactform #subject').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform #subject').parent().append('<label for="contactname" generated="true" class="error">Jums jāievada tēma!</label>');	
		...
		var hasClass=$j('#contactform #body').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform #body').parent().append('<label for="contactname" generated="true" class="error">Jums jāievada ziņa!</label>');	
...
function check_values_news() {
	...
	var errors=0;
	 ...
	 if($j('#newsletterform #name_news').val()=='') {
	 	...
	 	if(!hasClass)
	 	    $j('#newsletterform #name_news').parent().append('<label for="contactname" generated="true" class="error">Lūdzu, ievadiet savu vārdu</label>');
		...
		var hasClass=$j('#newsletterform #email_news').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#newsletterform #email_news').parent().append('<label for="contactname" generated="true" class="error">Lūdzu ievadiet derīgu e-pasta adresi</label>');	
	...
	if(errors==0) {
			document.getElementById("submit").disabled=true;
			document.getElementById("submit").value='Lūdzu uzgaidiet ..';
			sendRequest_news();
	}
}
